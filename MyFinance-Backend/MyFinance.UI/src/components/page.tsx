...
export function PageHeader({
  ...
  return (
    <header className="sticky left-0 top-0 z-30 flex h-14 items-center justify-between gap-4 border-b bg-background px-4 py-2 sm:static sm:z-auto sm:h-auto sm:border-b sm:bg-transparent sm:px-0">
